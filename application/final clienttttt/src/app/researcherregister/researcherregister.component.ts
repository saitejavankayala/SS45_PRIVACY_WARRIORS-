...
@Component({
  selector: 'app-researcherregister',
  templateUrl: './researcherregister.component.html',
  styleUrls: ['./researcherregister.component.scss']
})
export class ResearcherregisterComponent implements OnInit {
  model: any = {};
  loading = false;
