...
const routes: Routes = [
  ...
  { path: 'nurseregister', component:NurseregisterComponent},
  { path: 'radiologistregister', component:  RadiologistregisterComponent},
  { path: 'clinicianregister', component:ClinicianregisterComponent },
  { path: 'researcherregister', component: ResearcherregisterComponent  },
